...
## [<img src="https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **CCSAlphas** [<img src="https://github.com/QuantLet/Styleguide-and-Validation-procedure/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/d3/ia)
...
Keywords : Power Law, Crypto-Currencies, Alpha, Cross Section, plot

See also : 'CCSCryptoSurvival, CCSecdf, CCSHistMarketCap, CCSHistMarketCapHighValAreas,
...
Example : 'A plot showing the evolution of the alpha parameter in 3 different groups of
crypto-currencies ordered by market capitalization.'

```

![Picture1](CCSAlphas.png)
